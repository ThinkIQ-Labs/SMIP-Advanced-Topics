                        ...
                        <template v-for="aIndex in aMovement.maxActivityCount">
                            <tr>
                                <td :style="aIndex < aMovement.maxActivityCount || aMovement.showDetail(aIndex) ? 'border-bottom: 0px solid #dee2e6;' : ''">
                                    <span v-if="aIndex==1">{{aMovement.tsPretty}}</span>
                                </td>
                                ...
                                <td :style="aIndex < aMovement.maxActivityCount || aMovement.showDetail(aIndex) ? 'border-bottom: 0px solid #dee2e6;' : ''" style="border-left: 1px solid #dee2e6;">
                                    <button v-if="aMovement.sourceActivities.length >= aIndex" style="cursor: pointer; border:none; padding: revert;" class="list-group-item list-group-item-action" @click="onSelectActivity(aMovement.sourceActivities[aIndex-1])">
                                        {{accounts.find(x=>x.id==aMovement.sourceActivities[aIndex-1].accountId).displayName}}
                                    </button>
                                </td>
                                <td :style="aIndex < aMovement.maxActivityCount || aMovement.showDetail(aIndex) ? 'border-bottom: 0px solid #dee2e6;' : ''" ><span  v-if="aMovement.sourceActivities.length >= aIndex">{{Math.round(aMovement.sourceActivities[aIndex-1].startBalance*100)/100}}</span></td>
                                <td :style="aIndex < aMovement.maxActivityCount || aMovement.showDetail(aIndex) ? 'border-bottom: 0px solid #dee2e6;' : ''" ><span  v-if="aMovement.sourceActivities.length >= aIndex">{{Math.round(aMovement.sourceActivities[aIndex-1].endBalance*100)/100}}</span></td>
                                <td :style="aIndex < aMovement.maxActivityCount || aMovement.showDetail(aIndex) ? 'border-bottom: 0px solid #dee2e6;' : ''" >
                                    <span  v-if="aMovement.sourceActivities.length >= aIndex">
                                ...
                                <td :style="aIndex < aMovement.maxActivityCount || aMovement.showDetail(aIndex) ? 'border-bottom: 0px solid #dee2e6;' : ''" style="border-left: 1px solid #dee2e6;"><span  v-if="aMovement.coreActivities.length >= aIndex">{{Math.round(aMovement.coreActivities[aIndex-1].startBalance*100)/100}}</span></td>
                                <td :style="aIndex < aMovement.maxActivityCount || aMovement.showDetail(aIndex) ? 'border-bottom: 0px solid #dee2e6;' : ''" ><span  v-if="aMovement.coreActivities.length >= aIndex">{{Math.round(aMovement.coreActivities[aIndex-1].endBalance*100)/100}}</span></td>
                                <td :style="aIndex < aMovement.maxActivityCount || aMovement.showDetail(aIndex) ? 'border-bottom: 0px solid #dee2e6;' : ''" >
                                    <span  v-if="aMovement.coreActivities.length >= aIndex">
                                ...
                                <td :style="aIndex < aMovement.maxActivityCount || aMovement.showDetail(aIndex) ? 'border-bottom: 0px solid #dee2e6;' : ''" style="cursor: pointer; border-left: 1px solid #dee2e6;">
                                    <button v-if="aMovement.targetActivities.length >= aIndex" style="border:none; padding: revert;" class="list-group-item list-group-item-action" @click="onSelectActivity(aMovement.targetActivities[aIndex-1])">
                                        {{accounts.find(x=>x.id==aMovement.targetActivities[aIndex-1].accountId).displayName}}
                                    </button>
                                </td>
                                <td :style="aIndex < aMovement.maxActivityCount || aMovement.showDetail(aIndex) ? 'border-bottom: 0px solid #dee2e6;' : ''" ><span  v-if="aMovement.targetActivities.length >= aIndex">{{Math.round(aMovement.targetActivities[aIndex-1].startBalance*100)/100}}</span></td>
                                <td :style="aIndex < aMovement.maxActivityCount || aMovement.showDetail(aIndex) ? 'border-bottom: 0px solid #dee2e6;' : ''" ><span  v-if="aMovement.targetActivities.length >= aIndex">{{Math.round(aMovement.targetActivities[aIndex-1].endBalance*100)/100}}</span></td>
                                <td :style="aIndex < aMovement.maxActivityCount || aMovement.showDetail(aIndex) ? 'border-bottom: 0px solid #dee2e6;' : ''" >
                                    <span  v-if="aMovement.targetActivities.length >= aIndex">
