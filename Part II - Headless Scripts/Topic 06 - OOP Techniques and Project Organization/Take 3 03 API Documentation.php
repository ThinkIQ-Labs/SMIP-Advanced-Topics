    ...
    var app = new Vue({
        ...
        methods: {
            ...
            EchoAsync: async function(){
                let argument={
                    hello: JSON.parse(this.echoInput)
                };
                this.echoOutput = await tiqJSHelper.invokeScriptAsync(this.apiFileName, 'Echo', argument);

            },

            GetLibraryNamesAsync: async function(){
                this.getLibraryNames = await tiqJSHelper.invokeScriptAsync(this.apiFileName, 'GetLibraryNames', null);
            },

            GetLibraryByNameAsync: async function(){
                let argument={
                    libraryName: this.getLibraryByNameInput
                };
                this.getLibraryByName = await tiqJSHelper.invokeScriptAsync(this.apiFileName, 'GetLibraryByName', argument);
            },
